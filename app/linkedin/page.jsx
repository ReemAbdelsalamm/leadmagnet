...
export default function LinkedInPage() {
  ...
  useEffect(() => {
    document.title = "LinkedIn — LeadMagnet Inc";
  ...
  const checkConnection = async (userId) => {
    ...
    if (data) {
      setConnected(true);
      setLinkedinUser(data.linkedin_name || data.email || "LinkedIn account");
    }
  };
  ...
  const handleAddPost = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setSuccess("LinkedIn campaign started successfully.");
  ...
  const getCampaignName = (campaign, index) => {
    ...
    return `LinkedIn Campaign #${index + 1}`;
  };
  ...
  return (
    <main className="page-shell">
      <style>{`
        ...
        * {
        ...
        .linkedin-btn:hover {
          ...
          background: #0858a8;
          box-shadow: 0 16px 28px rgba(10,102,194,0.24);
        }
      ...
      <nav className="nav">
        <a href="/" className="logo" aria-label="LeadMagnet Inc home">
        ...
        <div className="nav-right">
          ...
          <a href="/linkedin" className="nav-link active">LinkedIn</a>
      ...
      <div className="layout">
        <aside className="sidebar">
          ...
          <a href="/linkedin" className="side-item active">
          ...
          <div className="content-inner">
            ...
            <div className="page-header">
              <div className="page-kicker">
                <span className="kicker-icon"><Icon name="linkedin" size={14} /></span>
                Platform Setup
              </div>
              <h1 className="page-title">LinkedIn Automation</h1>
              <p className="page-sub">
                Connect LinkedIn, choose posts to automate, and capture interested prospects directly into your LeadMagnet dashboard.
              </p>
            </div>
              ...
              <div className="connect-card">
                <div className="connect-top">
                  <div>
                    ...
                    <p className="connect-sub">
                      Connect your LinkedIn account with one click. We redirect you to LinkedIn to approve access — your password is never stored.
                    </p>
                  </div>

                  <div className="linkedin-badge">LinkedIn OAuth</div>
                </div>
                ...
                <div className="feature-grid">
                  <div className="feature-card">
                    ...
                    <div className="feature-desc">Automatically message prospects who engage with your posts.</div>
                  </div>

                  <div className="feature-card">
                    <div className="feature-icon"><Icon name="capture" /></div>
                    <div className="feature-title">Lead Capture</div>
                    <div className="feature-desc">Capture leads directly into your dashboard and export later.</div>
                  </div>

                  <div className="feature-card">
                    <div className="feature-icon"><Icon name="flow" /></div>
                    <div className="feature-title">Campaign Flow</div>
                    <div className="feature-desc">Turn post engagement into an organised follow-up pipeline.</div>
                  </div>
                </div>

                <button className="linkedin-btn" onClick={handleConnect}>
                  <Icon name="linkedin" />
              ...
              <>
                <div className="connected-bar">
                  <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                    ...
                    <div className="connected-text">LinkedIn connected — {linkedinUser}</div>
                  </div>

                  <button className="btn-primary" onClick={() => setShowAddPost(true)}>+ New Campaign</button>
                </div>

                <div className="section-header">
                  <div className="section-title">LinkedIn Campaigns</div>
                </div>

                {campaigns.length === 0 ? (
                  <div className="empty-state">
                    <span className="empty-icon"><Icon name="plus" size={24} /></span>
                    <div className="empty-title">Create your first LinkedIn campaign</div>
                    <div className="empty-sub">
                      Paste a LinkedIn post URL and create an automated follow-up message for people who engage with it.
                    </div>
                    <button className="btn-primary" onClick={() => setShowAddPost(true)}>Create Campaign</button>
                  </div>
                ) : (
      ...
      {showAddPost && (
        <div className="modal-overlay">
          <div className="modal">
            <div className="modal-title">Create LinkedIn Campaign</div>
            <div className="modal-sub">
              Paste a LinkedIn post URL and write the message that will be sent to prospects.
            </div>
            ...
            <form onSubmit={handleAddPost}>
              ...
              <div className="modal-btns">
                <button type="button" className="modal-cancel" onClick={() => setShowAddPost(false)}>Cancel</button>
